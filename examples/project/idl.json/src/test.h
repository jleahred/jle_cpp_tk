...
namespace idl { namespace pr {
    ...
    struct t_simple {
        ...
        //  from json
        t_simple (const std::string& );
    };
    std::ostream& operator<< (std::ostream& o, const t_simple& t);
    json to_json(const t_simple&);
    ...
    struct t_inline {
        ...
        //  from json
        t_inline (const std::string& );
    };
    std::ostream& operator<< (std::ostream& o, const t_inline& t);
    json to_json(const t_inline&);
    ...
    struct t_inline2 {
        ...
        //  from json
        t_inline2 (const std::string& );
    };
    std::ostream& operator<< (std::ostream& o, const t_inline2& t);
    json to_json(const t_inline2&);
    ...
    struct t_type_modifiers {
        ...
        //  from json
        t_type_modifiers (const std::string& );
    };
    std::ostream& operator<< (std::ostream& o, const t_type_modifiers& t);
    json to_json(const t_type_modifiers&);
...
struct t_composed {
    ...
    //  from json
    t_composed (const std::string& );
};
std::ostream& operator<< (std::ostream& o, const t_composed& t);
json to_json(const t_composed&);
